...
public class SimpleEventHandler implements ActivityStartEventHandler, ActivityEndEventHandler {
private final Map<Id<Person>, Double> personToStartTime =new HashMap<>();
    ...
    public void handleEvent(ActivityStartEvent event) {
        if(isInteraction(event.getActType()))return;
        System.out.println("Person "+event.getPersonId().toString()+ "started the activity"+event.getActType());
